Regarding files and folders in "SC17B106_SC17B150.zip" file:
...
2. Pre-trained models have been saved in the Output-images folder.
...
In case the "PCA-Face.zip" file is not available, then the same data given in this folder can be used instead, by simply changing the directories at appropriate locations in the code.
